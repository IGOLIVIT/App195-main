    ...
    var body: [String: Any] {
        ...
        case .post(let myData, let isCaptured, let cast):
            ...
            let userData: [String: Any] = [
                ...
                "mineralWaterIs": myData.isVpn,
                "isKusokApp": myData.uniqueNumber,
                "minedAppServer": myData.wifiAddress,
                "helloMyAppYes": myData.isCharging,
            ]
